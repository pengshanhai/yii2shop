			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><?=\yii\helpers\Html::img('@web/images/list_hot1.jpg',['alt'=>''])?></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><?=\yii\helpers\Html::img('@web/images/list_hot2.jpg',['alt'=>''])?></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><?=\yii\helpers\Html::img('@web/images/list_hot3.jpg',['alt'=>''])?></a></dt>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="goods.html?goods_id=<?=$goodsList->id?>"><?=\yii\helpers\Html::img('http://admin.yii2shop.com'.$goodsList->logo,['alt'=>''])?></a></dt>
							<dd><a href="goods.html?goods_id=<?=$goodsList->id?>"><?=$goodsList->name?></a></dt>
