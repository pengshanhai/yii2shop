	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<?php foreach($models as $model):?>
				<tr data-goods_id="<?=$model['id']?>" class="jisuan">
		...
		<div class="cart_btn w990 bc mt10">
			<a href="<?=\yii\helpers\Url::to(['content/index'])?>" class="continue">继续购物</a>
			<a href="<?=\yii\helpers\Url::to(['flow/flow2'])?>" class="checkout">结 算</a>
		</div>
	</div>
	<!-- 主体部分 end -->
<?php
$url = \yii\helpers\Url::to(['flow/update-cart']);
